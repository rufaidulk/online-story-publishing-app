...
-- Generation Time: Feb 13, 2022 at 03:56 AM
...
INSERT INTO `sequences` (`id`, `type`, `seq_no`) VALUES (1, 'subscriptionTxn', '0');
...
INSERT INTO `subscription_plans` (`id`, `type`, `name`, `is_premium`, `amount`, `period_in_days`, `status`) VALUES
(1, 10, 'BasicFree', 11, '0.00', 0, 10),
(2, 10, 'Premium30', 10, '100.00', 30, 10),
(3, 11, 'Premium365', 10, '1200.00', 365, 10);
...
ALTER TABLE `payment_transactions`
  ...
  ADD INDEX (`payment_transaction_id`);
